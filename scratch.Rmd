...
```{r}
demographic_sim2 <- reduce(1:nsim, ~population_dynamics(.x, food_ratio_c = 0.85), .init = test_pop1)
```
...
farming_sim <- accumulate(1:nsim, ~household_dynamics(.x) %>% population_dynamics, .init = test_pop3)
```
